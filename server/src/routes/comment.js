...
returns an array of Comment objects
*/
router.get("/employee/:mongo_id",verifyJWT, comment_controller.find_comments_by_employee)

/*
get all comments associated with goal Mongoose _id
returns an array of Comment objects 
*/
router.get("/goal/:mongo_id",verifyJWT, comment_controller.find_comments_by_goal)
